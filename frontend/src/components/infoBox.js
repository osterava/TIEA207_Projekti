 ...
 */
const InfoBox = ({ selectedCountry, populationData, selectedCountryGBDYear, selectedCountryCode, closeInfoBox, year, cgDebt, centralGovDebt, publicDebt, infoVisible }) => {
