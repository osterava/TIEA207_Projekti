  ...
  return (
    <footer className="footer">
      ...
      <div className='license_tab'>
        ...
        <img src={sale} alt="sale_license_logo" className='licenses'/>
        <img src={cc} alt="cc_license_logo" className='licenses'/>
        <img src={person} alt="person_license_logo" className='licenses'/>
      </div>
    </footer>
  )
}
